...
public class XslStyleSheetsJhove {

	public static void Jhove2TrimXsl() throws IOException {
		PrintWriter xslStyle = new PrintWriter(new FileWriter("C://JhoveFolder//Jhove2Trim.xsl")); // not
																									// hard
																									// coded
																									// please
	...
	public static void JhoveCustomizedXsl() throws IOException {
		...
		PrintWriter xslStyle = new PrintWriter(new FileWriter(jhoveValidations.JhoveGuiStarterDialog.jhoveExaminationFolder + "//" + "JhoveCustomized.xsl"));
		...
		xslStyle.println("<th>PdfType</th>");
		xslStyle.println("<th>Encryption</th>");
		...
		xslStyle.println("<td><xsl:value-of select=\"PdfType\"/></td>");
		xslStyle.println("<td><xsl:value-of select=\"Encryption\"/></td>");
	...
	public static void GifJhoveCustomizedXsl() throws IOException {
		...
		PrintWriter xslStyle = new PrintWriter(new FileWriter(jhoveValidations.JhoveGuiStarterDialog.jhoveExaminationFolder + "//" + "GifJhoveCustomized.xsl"));
...
//		PrintWriter xslStyle = new PrintWriter(new FileWriter(jhoveValidations.JhoveGuiStarterDialogObjects.jhoveExaminationFolder + "//" + "JhoveCustomized.xsl"));
//
//		xslStyle.println("<?xml version=\"1.0\"?>");
//		xslStyle.println("<xsl:stylesheet version=\"1.0\" xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\">");
//		xslStyle.println("<xsl:template match=\"/\">");
